 ...
 * Adapted from http://www.kurims.kyoto-u.ac.jp/~ooura/fft.html (Copyright Takuya OOURA,
 1996-2001)\n
 * ---------------------------------------------------\n
...
#define WR5000 \
	(PICOFFTSG_FFTTYPE)(0.707106781186547524400844362104849039284835937688 * PICODSP_WGT_SHIFT)
#ifndef WR2500 /* cos(M_PI_2*0.2500) */
#define WR2500 \
	(PICOFFTSG_FFTTYPE)(0.923879532511286756128183189396788286822416625863 * PICODSP_WGT_SHIFT)
#endif
#ifndef WI2500 /* sin(M_PI_2*0.2500) */
#define WI2500 \
	(PICOFFTSG_FFTTYPE)(0.382683432365089771728459984030398866761344562485 * PICODSP_WGT_SHIFT)
#endif
#ifndef WR1250 /* cos(M_PI_2*0.1250) */
#define WR1250 \
	(PICOFFTSG_FFTTYPE)(0.980785280403230449126182236134239036973933730893 * PICODSP_WGT_SHIFT)
#endif
#ifndef WI1250 /* sin(M_PI_2*0.1250) */
#define WI1250 \
	(PICOFFTSG_FFTTYPE)(0.195090322016128267848284868477022240927691617751 * PICODSP_WGT_SHIFT)
#endif
#ifndef WR3750 /* cos(M_PI_2*0.3750) */
#define WR3750 \
	(PICOFFTSG_FFTTYPE)(0.831469612302545237078788377617905756738560811987 * PICODSP_WGT_SHIFT)
#endif
#ifndef WI3750 /* sin(M_PI_2*0.3750) */
#define WI3750 \
	(PICOFFTSG_FFTTYPE)(0.555570233019602224742830813948532874374937190754 * PICODSP_WGT_SHIFT)
#endif
 ...
 * useful macros
 ************** */
#define picofftsg_highestBitPos(x)                                                               \
	(x == 0                                                                                      \
		 ? 0                                                                                     \
		 : (x >= POW17                                                                           \
				? (x >= POW25                                                                    \
					   ? (x >= POW29                                                             \
							  ? (x >= POW31 ? 31 : (x >= POW30 ? 30 : 29))                       \
							  : (x >= POW27 ? (x >= POW28 ? 28 : 27) : (x >= POW26 ? 26 : 25)))  \
					   : (x >= POW21                                                             \
							  ? (x >= POW23 ? (x >= POW24 ? 24 : 23) : (x >= POW22 ? 22 : 21))   \
							  : (x >= POW19 ? (x >= POW20 ? 20 : 19) : (x >= POW18 ? 18 : 17)))) \
				: (x >= POW9                                                                     \
					   ? (x >= POW13                                                             \
							  ? (x >= POW15 ? (x >= POW16 ? 16 : 15) : (x >= POW14 ? 14 : 13))   \
							  : (x >= POW11 ? (x >= POW12 ? 12 : 11) : (x >= POW10 ? 10 : 9)))   \
					   : (x >= POW5 ? (x >= POW7 ? (x >= POW8 ? 8 : 7) : (x >= POW6 ? 6 : 5))    \
									: (x >= POW3 ? (x >= POW4 ? 4 : 3) : (x >= POW2 ? 2 : 1))))))
#define picofftsg_highestBit(x)                                                                   \
	(x == 0                                                                                       \
		 ? 0                                                                                      \
		 : (x < 0 ? (zz = -x,                                                                     \
					 (zz >= POW17                                                                 \
						  ? (zz >= POW25                                                          \
								 ? (zz >= POW29 ? (zz >= POW31 ? 31 : (zz >= POW30 ? 30 : 29))    \
												: (zz >= POW27 ? (zz >= POW28 ? 28 : 27)          \
															   : (zz >= POW26 ? 26 : 25)))        \
								 : (zz >= POW21 ? (zz >= POW23 ? (zz >= POW24 ? 24 : 23)          \
															   : (zz >= POW22 ? 22 : 21))         \
												: (zz >= POW19 ? (zz >= POW20 ? 20 : 19)          \
															   : (zz >= POW18 ? 18 : 17))))       \
						  : (zz >= POW9 ? (zz >= POW13 ? (zz >= POW15 ? (zz >= POW16 ? 16 : 15)   \
																	  : (zz >= POW14 ? 14 : 13))  \
													   : (zz >= POW11 ? (zz >= POW12 ? 12 : 11)   \
																	  : (zz >= POW10 ? 10 : 9)))  \
										: (zz >= POW5 ? (zz >= POW7 ? (zz >= POW8 ? 8 : 7)        \
																	: (zz >= POW6 ? 6 : 5))       \
													  : (zz >= POW3 ? (zz >= POW4 ? 4 : 3)        \
																	: (zz >= POW2 ? 2 : 1))))))   \
				  : (x >= POW17                                                                   \
						 ? (x >= POW25 ? (x >= POW29 ? (x >= POW31 ? 31 : (x >= POW30 ? 30 : 29)) \
													 : (x >= POW27 ? (x >= POW28 ? 28 : 27)       \
																   : (x >= POW26 ? 26 : 25)))     \
									   : (x >= POW21 ? (x >= POW23 ? (x >= POW24 ? 24 : 23)       \
																   : (x >= POW22 ? 22 : 21))      \
													 : (x >= POW19 ? (x >= POW20 ? 20 : 19)       \
																   : (x >= POW18 ? 18 : 17))))    \
						 : (x >= POW9 ? (x >= POW13 ? (x >= POW15 ? (x >= POW16 ? 16 : 15)        \
																  : (x >= POW14 ? 14 : 13))       \
													: (x >= POW11 ? (x >= POW12 ? 12 : 11)        \
																  : (x >= POW10 ? 10 : 9)))       \
									  : (x >= POW5 ? (x >= POW7 ? (x >= POW8 ? 8 : 7)             \
																: (x >= POW6 ? 6 : 5))            \
												   : (x >= POW3 ? (x >= POW4 ? 4 : 3)             \
																: (x >= POW2 ? 2 : 1)))))))
...
picoos_single norm_result(picoos_int32 m2,
						  PICOFFTSG_FFTTYPE* tmpX,
						  PICOFFTSG_FFTTYPE* norm_window) {
	picoos_int16 nI;
...
void bitrv216(PICOFFTSG_FFTTYPE* a) {
	PICOFFTSG_FFTTYPE x1r, x1i, x2r, x2i, x3r, x3i, x4r, x4i, x5r, x5i, x7r, x7i, x8r, x8i, x10r,
		x10i, x11r, x11i, x12r, x12i, x13r, x13i, x14r, x14i;
...
void bitrv216neg(PICOFFTSG_FFTTYPE* a) {
	PICOFFTSG_FFTTYPE x1r, x1i, x2r, x2i, x3r, x3i, x4r, x4i, x5r, x5i, x6r, x6i, x7r, x7i, x8r,
		x8i, x9r, x9i, x10r, x10i, x11r, x11i, x12r, x12i, x13r, x13i, x14r, x14i, x15r, x15i;
...
void bitrv208neg(PICOFFTSG_FFTTYPE* a) {
	PICOFFTSG_FFTTYPE x1r, x1i, x2r, x2i, x3r, x3i, x4r, x4i, x5r, x5i, x6r, x6i, x7r, x7i;
...
void cftb1st(picoos_int32 n, PICOFFTSG_FFTTYPE* a) {
	...
	PICOFFTSG_FFTTYPE wk1r, wk1i, wk3r, wk3i, wd1r, wd1i, wd3r, wd3i, ss1, ss3;
...
void cftmdl2(picoos_int32 n, PICOFFTSG_FFTTYPE* a) {
	picoos_int32 i, i0, j, j0, j1, j2, j3, m, mh;
	PICOFFTSG_FFTTYPE wn4r, wk1r, wk1i, wk3r, wk3i, wl1r, wl1i, wl3r, wl3i, wd1r, wd1i, wd3r, wd3i,
...
void cftf161(PICOFFTSG_FFTTYPE* a) {
	PICOFFTSG_FFTTYPE wn4r, wk1r, wk1i, x0r, x0i, x1r, x1i, x2r, x2i, x3r, x3i, y0r, y0i, y1r, y1i,
...
void cftf162(PICOFFTSG_FFTTYPE* a) {
	PICOFFTSG_FFTTYPE wn4r, wk1r, wk1i, wk2r, wk2i, wk3r, wk3i, x0r, x0i, x1r, x1i, x2r, x2i, y0r,
		y0i, y1r, y1i, y2r, y2i, y3r, y3i, y4r, y4i, y5r, y5i, y6r, y6i, y7r, y7i, y8r, y8i, y9r,
		y9i, y10r, y10i, y11r, y11i, y12r, y12i, y13r, y13i, y14r, y14i, y15r, y15i;
...
void cftf081(PICOFFTSG_FFTTYPE* a) {
	PICOFFTSG_FFTTYPE wn4r, x0r, x0i, x1r, x1i, x2r, x2i, x3r, x3i, y0r, y0i, y1r, y1i, y2r, y2i,
...
void cftf082(PICOFFTSG_FFTTYPE* a) {
	PICOFFTSG_FFTTYPE wn4r, wk1r, wk1i, x0r, x0i, x1r, x1i, y0r, y0i, y1r, y1i, y2r, y2i, y3r, y3i,
...
void rftfsub(picoos_int32 n, PICOFFTSG_FFTTYPE* a) {
	...
	switch (n) {
		case 8:
			wdi = (PICOFFTSG_FFTTYPE)(0.353553414345 * PICODSP_WGT_SHIFT);
			wdr = (PICOFFTSG_FFTTYPE)(0.146446630359 * PICODSP_WGT_SHIFT);
			w1r = (PICOFFTSG_FFTTYPE)(0.707106709480 * PICODSP_WGT_SHIFT);
			w1i = (PICOFFTSG_FFTTYPE)(0.707106828690 * PICODSP_WGT_SHIFT);
			ss = (PICOFFTSG_FFTTYPE)(1.414213657379 * PICODSP_WGT_SHIFT);
			break;
		case 16:
			wdi = (PICOFFTSG_FFTTYPE)(0.191341713071 * PICODSP_WGT_SHIFT);
			wdr = (PICOFFTSG_FFTTYPE)(0.038060232997 * PICODSP_WGT_SHIFT);
			w1r = (PICOFFTSG_FFTTYPE)(0.923879504204 * PICODSP_WGT_SHIFT);
			w1i = (PICOFFTSG_FFTTYPE)(0.382683426142 * PICODSP_WGT_SHIFT);
			ss = (PICOFFTSG_FFTTYPE)(0.765366852283 * PICODSP_WGT_SHIFT);
			break;
		case 32:
			wdi = (PICOFFTSG_FFTTYPE)(0.097545161843 * PICODSP_WGT_SHIFT);
			wdr = (PICOFFTSG_FFTTYPE)(0.009607359767 * PICODSP_WGT_SHIFT);
			w1r = (PICOFFTSG_FFTTYPE)(0.980785250664 * PICODSP_WGT_SHIFT);
			w1i = (PICOFFTSG_FFTTYPE)(0.195090323687 * PICODSP_WGT_SHIFT);
			ss = (PICOFFTSG_FFTTYPE)(0.390180647373 * PICODSP_WGT_SHIFT);
			break;
		case 64:
			wdi = (PICOFFTSG_FFTTYPE)(0.049008570611 * PICODSP_WGT_SHIFT);
			wdr = (PICOFFTSG_FFTTYPE)(0.002407636726 * PICODSP_WGT_SHIFT);
			w1r = (PICOFFTSG_FFTTYPE)(0.995184719563 * PICODSP_WGT_SHIFT);
			w1i = (PICOFFTSG_FFTTYPE)(0.098017141223 * PICODSP_WGT_SHIFT);
			ss = (PICOFFTSG_FFTTYPE)(0.196034282446 * PICODSP_WGT_SHIFT);
			break;
		default:
			wdr = 0;
			wdi = 0;
...
void dctsub(picoos_int32 n, PICOFFTSG_FFTTYPE* a) {
	...
	switch (n) {
		case 8:
			wdi = (PICOFFTSG_FFTTYPE)(0.587937772274 * PICODSP_WGT_SHIFT);
			wdr = (PICOFFTSG_FFTTYPE)(0.392847478390 * PICODSP_WGT_SHIFT);
			w1r = (PICOFFTSG_FFTTYPE)(0.980785250664 * PICODSP_WGT_SHIFT);
			w1i = (PICOFFTSG_FFTTYPE)(0.195090323687 * PICODSP_WGT_SHIFT);
			ss = (PICOFFTSG_FFTTYPE)(0.390180647373 * PICODSP_WGT_SHIFT);
			break;
		case 16:
			wdi = (PICOFFTSG_FFTTYPE)(0.546600937843 * PICODSP_WGT_SHIFT);
			wdr = (PICOFFTSG_FFTTYPE)(0.448583781719 * PICODSP_WGT_SHIFT);
			w1r = (PICOFFTSG_FFTTYPE)(0.995184719563 * PICODSP_WGT_SHIFT);
			w1i = (PICOFFTSG_FFTTYPE)(0.098017141223 * PICODSP_WGT_SHIFT);
			ss = (PICOFFTSG_FFTTYPE)(0.196034282446 * PICODSP_WGT_SHIFT);
			break;
		case 32:
			wdi = (PICOFFTSG_FFTTYPE)(0.523931562901 * PICODSP_WGT_SHIFT);
			wdr = (PICOFFTSG_FFTTYPE)(0.474863886833 * PICODSP_WGT_SHIFT);
			w1r = (PICOFFTSG_FFTTYPE)(0.998795449734 * PICODSP_WGT_SHIFT);
			w1i = (PICOFFTSG_FFTTYPE)(0.049067676067 * PICODSP_WGT_SHIFT);
			ss = (PICOFFTSG_FFTTYPE)(0.098135352135 * PICODSP_WGT_SHIFT);
			break;
		case 64:
			wdi = (PICOFFTSG_FFTTYPE)(0.512120008469 * PICODSP_WGT_SHIFT);
			wdr = (PICOFFTSG_FFTTYPE)(0.487578809261 * PICODSP_WGT_SHIFT);
			w1r = (PICOFFTSG_FFTTYPE)(0.999698817730 * PICODSP_WGT_SHIFT);
			w1i = (PICOFFTSG_FFTTYPE)(0.024541229010 * PICODSP_WGT_SHIFT);
			ss = (PICOFFTSG_FFTTYPE)(0.049082458019 * PICODSP_WGT_SHIFT);
			break;
