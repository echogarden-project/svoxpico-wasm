...
#define PICOKNOW_KBID_WPHO_ARRAY                                                      \
	{                                                                                 \
		PICOKNOW_KBID_FST_WPHO_1, PICOKNOW_KBID_FST_WPHO_2, PICOKNOW_KBID_FST_WPHO_3, \
			PICOKNOW_KBID_FST_WPHO_4, PICOKNOW_KBID_FST_WPHO_5                        \
	}

#define PICOKNOW_KBID_SPHO_ARRAY                                                          \
	{                                                                                     \
		PICOKNOW_KBID_FST_SPHO_1, PICOKNOW_KBID_FST_SPHO_2, PICOKNOW_KBID_FST_SPHO_3,     \
			PICOKNOW_KBID_FST_SPHO_4, PICOKNOW_KBID_FST_SPHO_5, PICOKNOW_KBID_FST_SPHO_6, \
			PICOKNOW_KBID_FST_SPHO_7, PICOKNOW_KBID_FST_SPHO_8, PICOKNOW_KBID_FST_SPHO_9, \
			PICOKNOW_KBID_FST_SPHO_10                                                     \
	}

#define PICOKNOW_KBID_ULEX_ARRAY \
	{ PICOKNOW_KBID_LEX_USER_1, PICOKNOW_KBID_LEX_USER_2, }

#define PICOKNOW_KBID_UTPP_ARRAY \
	{ PICOKNOW_KBID_TPP_USER_1, PICOKNOW_KBID_TPP_USER_2, }
...
typedef pico_status_t (*picoknow_kbSubDeallocate)(register picoknow_KnowledgeBase that,
...
extern void picoknow_disposeKnowledgeBase(picoos_MemoryManager mm, picoknow_KnowledgeBase* that);
