...
enum picofst_transduction_mode {
	PICOKFST_TRANSMODE_NEWSYMS =
		1,						   /* e.g. {#WB},{#PB-S},{#PB-W},{#ACC0},{#ACC1},{#ACC2},{#ACC3}, */
...
pico_status_t picokfst_specializeFSTKnowledgeBase(picoknow_KnowledgeBase that,
...
picokfst_FST picokfst_getFST(picoknow_KnowledgeBase that);
...
picoos_uint8 picokfst_kfstGetTransductionMode(picokfst_FST that);

/* returns number of states and number of pair classes in FST;
   legal states are 1..nrStates, legal classes are 1..nrClasses */
void picokfst_kfstGetFSTSizes(picokfst_FST that, picoos_int32* nrStates, picoos_int32* nrClasses);
...
void picokfst_kfstStartPairSearch(picokfst_FST that,
...
void picokfst_kfstGetNextPair(picokfst_FST that,
							  picoos_int32* searchState,
...
void picokfst_kfstGetTrans(picokfst_FST that,
...
void picokfst_kfstStartInEpsTransSearch(picokfst_FST that,
										picokfst_state_t startState,
...
void picokfst_kfstGetNextInEpsTrans(picokfst_FST that,
									picoos_int32* searchState,
									picoos_bool* inEpsTransFound,
									picokfst_symid_t* outSym,
									picokfst_state_t* endState);
...
picoos_bool picokfst_kfstIsAcceptingState(picokfst_FST that, picokfst_state_t state);
