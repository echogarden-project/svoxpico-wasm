 ...
 * - Colecting the parametric output of the Decision trees into suitable items to be sent to
 following PU's
 *
 ...
 * - While building the symbolic feature vector set for the sentence this data structure stores
 syllable relevant data.
 *   The corresponding phonetic data is stored outside as a single string of phonetic id's for all
 the sentence.
 * - While feeding the decision trees the data structure is used to represent data for phonemes of
 the syllable
 * - Addiotional data strucures are mantained to temporarily store items not pertaining to the PAM
 processing, for later resynchronization
 *
